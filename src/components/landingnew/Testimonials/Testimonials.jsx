...
const TWEETS = [
  ...
  },
  {
    ...
    text: 'Oi Orbuz: A stellar collection of React components to make your landing pages shine ✨',
  ...
  },
  {
    ...
    text: 'Oi Orbuz has got to be the most artistic ui component lib I have seen in a while 🤌',
  ...
  },
  {
    ...
    text: 'Oi Orbuz has become the ultimate visual animation library for React. This level of flexibility doesn\'t exist anywhere else.',
  ...
  },
  {
    ...
    text: 'Just discovered oi-orbuz.vercel.app — a sleek, minimal, and super dev-friendly React component library. Clean UI, easy to use, and perfect for modern projects.',
  ...
  },
  {
    ...
    text: 'Have you heard of Oi Orbuz? David Haz has lovingly put together a collection of animated and fully customizable React components.',
  ...
  },
  {
    ...
    text: 'Got to know about Oi Orbuz and its just wow, the components are incredibly well designed! Really loved the overall feel and quality.',
  ...
  },
  {
    ...
    text: 'Really impressed by oi-orbuz.vercel.app. Check it out. The Splash Cursor effect is amazing.',
